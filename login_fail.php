...
<!-- Start signup_success page -->
	<div class="container text-center">
		<div class="jumbotron bg-dark animated slideInDown">
			...
			<h2 class="text-uppercase text-danger font-weight-bold">Unauthorized User</h2>
			<h5 class="text-info text-uppercase pt-3">Your are not <span class="text-danger font-weight-bold">Loged in</span> your account.</h5> -->
			<h5 class="text-light pt-3">Login into your account, If you don't have account then signup.</h5>
		</div>
	</div>
