...
<!-- Start signup_success page -->
	<div class="container text-center">
		<div class="jumbotron bg-dark animated slideInDown">
			...
			<h2 class="text-uppercase text-danger font-weight-bold">Unverified</h2>
			<h5 class="text-info text-uppercase pt-3">Your email could not <span class="text-danger font-weight-bold">verified!</span></h5> -->
			<h5 class="text-light pt-3">Invalid email or already verified. Try again with another email</h5>
		</div>
	</div>
