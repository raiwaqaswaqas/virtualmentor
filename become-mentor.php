...
include("include/mentor-user.php");
...
<body spellcheck="true">
	...
	<!-- Start jumbotron -->
		<div class="jumbotron jumbotron-fluid bg-secondary text-light">
			<div class="container">
				<h2 class="font-weight-bold">Become Mentor</h2>
				<p class="lead font-italic">“The job of an educator is to teach students to see<br> vitality in themselves” <span class="font-weight-bold">― Joseph Campbell</span> </p>
			</div>
		</div>
	<!-- End jumbotron -->
			...
			<div class="col-md-6">
				...
				<form method="POST">
					<div class="form-group">
						<label>About:</label>
						<textarea class="form-control" name="m_about" rows="3" placeholder="Write about you . . ." autofocus="" required=""></textarea>
					</div>
					<div class="form-group">
						<label>Teaching Experience:</label>
						<input type="text" name="m_experience" class="form-control" required="">
					</div>
					<hr class="my-5">
					<div class="form-group">
						<label>Qualification:</label>
						<input type="text" name="m_qualification" class="form-control" required="">
					...
					<div class="form-group">
						...
						<input type="text" name="m_language" class="form-control" required="">
					</div>
					<hr class="my-5">
					<div class="form-group">
					...
					<input type="submit" name="m_submit" class="form-control btn btn-outline-secondary btn-sm mt-5" value="Submit">
				</form>
			</div>
		</div><hr class="my-5">
	</div> 	
